...
#datasets inladen
netflix_basis = pd.read_csv('NetflixOriginals.csv', encoding = 'ISO-8859-1')
netflix_extra = pd.read_csv('netflix_original_movie_data.csv', encoding = 'ISO-8859-1')
...
fig.update_layout(title_text='Amazon heeft een grotere std. dev. te hebben', xaxis_title = 'IMDB-score', yaxis_title = 'Kans dichtheid')
